 ...
 * 表现用的对象
 */
function GenAnimObj<T extends BaseAnimObj>( animClass:{new (name:string,model:Laya.MeshSprite3D): T; Name():string },model:Laya.MeshSprite3D ):T
{
...
abstract class BaseAnimObj extends Laya.MeshSprite3D
{
    Reset()
    {
        this.active = true;
...
class AnimCoin extends BaseAnimObj
{
    static Name():string
    {
        return "AnimCoin";
