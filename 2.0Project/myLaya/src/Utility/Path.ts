export module path
{
    ...
    {
        return UIPath + fileName+".atlas?v=" + this.resVersion;
    }
    /**
     * 获取UIJson路径
     * @param fileName 文件名
    ...
    {
        return  UIPath+fileName+".json?v=" + this.resVersion;
    }
    /**
     * 获取lh文件路径
     * @param fileName 文件名
    ...
    {
        return ModelPath +SceneAssetPath+fileName+"/Conventional/" +fileName + ".lh?v=" + this.resVersion;
    }
} 